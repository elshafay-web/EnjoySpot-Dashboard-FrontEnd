...
const LookupsData: Array<ILookups> = [
  ...
  {
    addApi: HttpPaths.Api_Language_Upsert,
    deleteApi: HttpPaths.Api_Language_Delete,
    getApi: HttpPaths.Api_Language_GetAll,
    toggleApi: HttpPaths.Api_Language_ToggleIsActive,
    profileApi: HttpPaths.Api_Language_Profile,
    icon: 'fa-solid fa-language',
    moduleName: 'Shared',
    routing: '/lookups/language',
    menuRouting: '/lookups/language',
    title: 'Languages',
    columns: [
      { field: 'languageCode', header: 'Language Code' },
      { field: 'name', header: 'Name' },
      { field: 'isActive', header: 'Status' },
      { field: 'countryFlagImage', header: 'Flag' },
    ],
    inputs: [
      {
        name: 'languageCode',
